...
// --- SENSOR ADDRESSES ---
// To find your sensor addresses, open the "FindSensorAddresses" folder and
// upload the "FindAddresses.ino" sketch to your device. Open the Serial
// Monitor, and the addresses for each connected sensor will be displayed.
//
// Copy the addresses for your oil temp, IAT, and engine temp sensors
...
// Replace these placeholders with your actual sensor addresses:
